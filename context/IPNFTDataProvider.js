...
import { useGraphQLData } from "../context/hooks/IPuseGraphQLData"
import { useMetadata } from "./hooks/IPuseMetadata"
...
export const NFTProvider = ({ children }) => {
    ...
    const { metadata, isLoadingMetadata, isErrorMetadata } = useMetadata([
        ...activeItems,
        ...inactiveItems,
    ])
    console.log(
