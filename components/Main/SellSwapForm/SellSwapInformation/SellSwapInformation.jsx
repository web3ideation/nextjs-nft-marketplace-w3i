    ...
    return (
        <div className={styles.sellSwapInformationWrapper}>
            <div className={styles.sellSwapInformation}>
                ...
                <h4>Token ID:</h4>
                <p>
                    Each NFT has a distinct Token ID. Enter this Token ID carefully, as it uniquely
                    identifies your NFT within its collection or contract. Incorrect entry of the
                    Token ID could lead to listing a different asset than intended.
                </p>
                <br></br>
                ...
                <p>
                    Each NFT you aim to receive in a trade has a distinct Token ID. Carefully enter
                    this Token ID, as it uniquely identifies the NFT within its collection or
                    contract. An incorrect Token ID could result in a different asset being
                    exchanged than the one you intended.
                </p>
                <br></br>
                <h4>Approval for Marketplace:</h4>
                <p>
                    Before listing your NFT, it must first be approved for the marketplace. This
                    approval process ensures that your NFT meets all necessary criteria and
                    standards for listing. Once approved, you can proceed with listing your NFT on
                    the platform.
                </p>
                <br></br>
                <h4>Confirmation and Transaction:</h4>
                <p>
                    After entering your price and obtaining marketplace approval, you must confirm
                    the transaction. This is usually done via your connected wallet. Make sure you
                    have enough ETH in your wallet to cover network fees.
                </p>
                <br></br>
                <h4>Visibility of your offer:</h4>
                <p>
                    Once you have set the price, obtained approval, and confirmed the transaction,
                    your offer will be visible on the market with the new price. This increases the
                    chance that potential buyers will become aware of your offer.
                </p>
                <br></br>
